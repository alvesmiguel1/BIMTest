...
public class App {
	...
	public static void main(String[] args) {
		...
		try {	
			...
			//bimengine.addNewProject("test");
			//bimengine.checkIfcFile("AC11-Institute-Var-2-IFC.ifc");
			bimengine.initializeProject("test");
			...
			Map<IfcRoot, List<Object>> related5 = bimengine.join(object5.get(object5.keySet().iterator().next()), relObjects5);
		...
		} catch (BIMServerConnectionException e) {
			System.err.println(e.getMessage());
		} catch (ModelRefreshException e) {
			System.err.println(e.getMessage());
